...
var logger = {
    ...
    Метод emit вызывает добавленные (не удаленные) обработчики в порядке добавления.
    Если добавить один и тот же обработчик два раза, то при emit он выполнится два раза.
    */
