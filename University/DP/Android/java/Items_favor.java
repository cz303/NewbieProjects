...
public class Items_favor extends ActionBarActivity {
    ...
    private static final String url_cat = mainactivity.URL + "/mobile_module/get_items_fav.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_items_favor);
    ...
    class LoadItems extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(Items_favor.this);
        ...
        protected String doInBackground(String... args) {
            ...
            String login_name = login_ck.getString("login_name","");
           // String login_name = "admin";
            Log.d("Login", login_name);
            params.add(new BasicNameValuePair("login", login_name));
        ...
        protected void onPostExecute(String file_url) {
            ...
            ListAdapter adapter = new SimpleAdapter(
                    Items_favor.this, itemsList,
                    R.layout.list_item_date,
                    new String[]{TAG_ID, TAG_NAME, TAG_DATE},
                    new int[]{R.id.id, R.id.name, R.id.date});
            // обновляем listview
